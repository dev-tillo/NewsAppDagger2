...
import com.example.newsappdagger2.databinding.FragmentGridBinding


class Grid : Fragment() {

    private lateinit var fragment: FragmentGridBinding
    ...
    override fun onCreateView(
        ...
        fragment = FragmentGridBinding.inflate(inflater, container, false)
        ...
        categoryrvAdapter =
            CategoryrvAdapter(
                requireContext(),
                list, object : CategoryrvAdapter.onClick {
